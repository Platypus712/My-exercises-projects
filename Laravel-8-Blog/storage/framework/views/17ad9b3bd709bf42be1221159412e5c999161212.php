        ...
        <nav class="md:flex md:justify-between md:items-center">
            ...
            <div class="mt-8 md:mt-0 flex items-center">
                <?php if(auth()->guard()->check()): ?>
                    <a class="text-xs font-bold uppercase">Welcome back, <?php echo e(auth()->user()->name); ?> !</a>
...
<?php /**PATH C:\xampp\htdocs\Laravel\Laravel\resources\views/components/layout.blade.php ENDPATH**/ ?>