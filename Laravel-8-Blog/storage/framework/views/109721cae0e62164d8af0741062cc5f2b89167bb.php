...
<?php $component->withAttributes([]); ?>
        <form action="/posts/<?php echo e($post->slug); ?>/comments" method="POST">
            ...
            <div class="mt-6"><textarea name="body" id="" class="w-full text-sm focus:outline-none focus:ring"
...
<?php else: ?>
    <p class="font-semibold"><a href="/register" class="hover:underline">Register</a> or <a href="/login"
        ...
        comment!</p>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Laravel\Laravel\resources\views/posts/_add-comment-form.blade.php ENDPATH**/ ?>