...
<?php $component->withAttributes(['class' => 'bg-gray-50']); ?>
    <article class="flex space-x-4">
        <div class="flex-shrink-0">
            <img src="https://i.pravatar.cc/100?u=<?php echo e($comment->user_id); ?>" alt="" width="60" height="60"
                class="rounded-xl">
        </div>
        ...
        <div>
            <header class="mb-4">
                ...
                <p class="text-xs">Posted <time><?php echo e($comment->created_at->format('F j, Y, g:i a')); ?></time> </p>
            </header>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Laravel\Laravel\resources\views/components/post-comment.blade.php ENDPATH**/ ?>